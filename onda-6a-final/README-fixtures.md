...
| --------------------- | ---------------- | -------------------------------------------------------- |
| `broche-simples.svg`  | 60.08 × 25.08 mm | Camada principal "Broche" — só o contorno                |
...
| `aplique-2-pill.svg`      | ⚠️ **PENDENTE — REUPAR** | Retângulo arredondado (pill/cápsula) — 95.2 × 15.2 mm |
| `aplique-3.svg`           | (verificar)              | Formato a definir                                     |

**⚠️ AÇÃO PENDENTE:** o arquivo `APLIQUE_2.svg` foi mencionado no planejamento da
Onda 6 mas não está disponível no momento da criação destas fixtures. Ele deve
ser reupado e copiado pra `apliques/aplique-2-pill.svg` antes da Onda 6 começar.

---

## exportacoes/

Pasta `pedido-placa-advogada/` contém um cenário completo de exportação real:
...
## Regras de uso (ADR 008 e ADR 009)
